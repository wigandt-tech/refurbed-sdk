...
/**
 * CalculateRefundOrderRequest Class Doc Comment
 *
 * @category Class
 * @package  WigandtTech\Refurbed
 * @author   OpenAPI Generator team
 ...
 */
class CalculateRefundOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalculateRefundOrderRequest';
     ...
     * Sets id
     *
     * @param string $id The id of the order to calculate a full refund values for.
     *
     * @return self
     */

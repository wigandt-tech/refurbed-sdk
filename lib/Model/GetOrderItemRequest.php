...
/**
 * GetOrderItemRequest Class Doc Comment
 *
 * @category Class
 * @package  WigandtTech\Refurbed
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderItemRequest';
     ...
     * Sets id
     *
     * @param string $id The id of the order item to get.
     *
     * @return self
     */

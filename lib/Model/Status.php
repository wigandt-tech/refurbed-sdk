...
class Status implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => 'int',
        'message' => 'string',
        'details' => '\WigandtTech\Refurbed\Model\Any[]'
    ];
     ...
     * Gets details
     *
     * @return \WigandtTech\Refurbed\Model\Any[]|null
     */
     ...
     * Sets details
     *
     * @param \WigandtTech\Refurbed\Model\Any[]|null $details A list of messages that carry the error details.  There is a common set of message types for APIs to use.
     *
     * @return self
     */

...
/**
 * GetInstanceRequest Class Doc Comment
 *
 * @category Class
 * @package  WigandtTech\Refurbed
 * @author   OpenAPI Generator team
 ...
 */
class GetInstanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInstanceRequest';
     ...
     * Sets gtin
     *
     * @param string|null $gtin A GTIN-8, GTIN-12 or GTIN-13. Note that EAN-13 and UPC-A codes are GTINs.
     *
     * @return self
     */

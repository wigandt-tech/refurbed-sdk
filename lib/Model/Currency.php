...
class Currency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => '\WigandtTech\Refurbed\Model\CurrencyCode',
        'exchangeRates' => '\WigandtTech\Refurbed\Model\ExchangeRate[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['exchangeRates'] = $data['exchangeRates'] ?? null;
    }
     ...
     * Sets code
     *
     * @param \WigandtTech\Refurbed\Model\CurrencyCode|null $code code
     *
     * @return self
     */
     ...
     * Gets exchangeRates
     *
     * @return \WigandtTech\Refurbed\Model\ExchangeRate[]|null
     */
     ...
     * Sets exchangeRates
     *
     * @param \WigandtTech\Refurbed\Model\ExchangeRate[]|null $exchangeRates Lists the current exchange rates to all other currencies.  This is a snapshot in time and there is no guarantee that new orders will be using the exchange rates returned.
     *
     * @return self
     */

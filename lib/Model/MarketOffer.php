 ...
 */
class MarketOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketOffer';
    ...
    protected static $openAPITypes = [
        'id' => '\WigandtTech\Refurbed\Model\MarketOfferIdentifier',
        'version' => 'string',
        'isCurrent' => 'bool',
        'createdAt' => '\DateTime',
        'instanceId' => 'string',
        ...
        'marketPrice' => '\WigandtTech\Refurbed\Model\OfferMarketPrice'
    ];
     ...
     * Gets id
     *
     * @return \WigandtTech\Refurbed\Model\MarketOfferIdentifier|null
     */
     ...
     * Sets id
     *
     * @param \WigandtTech\Refurbed\Model\MarketOfferIdentifier|null $id id
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version Version of this offer / offer market price.
     *
     * @return self
     */
     ...
     * Sets referencePrice
     *
     * @param string|null $referencePrice Reference gross price of this offer. The reference price is used to calculate prices if they are not defined for a market.
     *
     * @return self
     */
     ...
     *
     * @param string|null $referenceMinPrice Optional reference minimum price in market currency for automatic repricing. The reference minimum price is used to calculate minimum prices if they are not defined for a market.
     *
     * @return self
     */
     ...
     * Sets marketPrice
     *
     * @param \WigandtTech\Refurbed\Model\OfferMarketPrice|null $marketPrice marketPrice
     *
     * @return self
     */

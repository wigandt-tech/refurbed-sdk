...
/**
 * BatchGetOffersRequestGet Class Doc Comment
 *
 * @category Class
 * @package  WigandtTech\Refurbed
 * @author   OpenAPI Generator team
 ...
 */
class BatchGetOffersRequestGet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchGetOffersRequest.Get';
     ...
     * Sets version
     *
     * @param string|null $version Offer version. Assumes \"current\", if not set.
     *
     * @return self
     */

...
class OrderLabel
{
    ...
    const PARTIALLY_REJECTED = 'PARTIALLY_REJECTED';
    ...
    const MISSING_PARCEL_TRACKING_URLS = 'MISSING_PARCEL_TRACKING_URLS';

    const MISSING_ITEM_IDENTIFIERS = 'MISSING_ITEM_IDENTIFIERS';

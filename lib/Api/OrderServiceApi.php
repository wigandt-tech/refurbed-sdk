...
class OrderServiceApi
{
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\CalculateRefundOrderResponse' === '\SplFileObject') {
                        ...
                        if ('\WigandtTech\Refurbed\Model\CalculateRefundOrderResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\GetOrderResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\GetOrderResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\GetOrderInvoiceResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\GetOrderInvoiceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\ListOrdersResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\ListOrdersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\RefundOrderResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\RefundOrderResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     *
     * @param  \WigandtTech\Refurbed\Model\SetOrderInvoiceRequestInner[] $body (streaming inputs) (required)
     *
     * @throws \WigandtTech\Refurbed\ApiException on non-2xx response
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\SetOrderInvoiceResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\SetOrderInvoiceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

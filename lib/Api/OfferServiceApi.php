            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\BatchCreateOffersResponse' === '\SplFileObject') {
                        ...
                        if ('\WigandtTech\Refurbed\Model\BatchCreateOffersResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\BatchDeleteOffersResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\BatchDeleteOffersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\BatchGetOffersResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\BatchGetOffersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\BatchUpdateOffersResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\BatchUpdateOffersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\CreateOfferResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\CreateOfferResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\GetOfferResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\GetOfferResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\ListOffersResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\ListOffersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\WigandtTech\Refurbed\Model\UpdateOfferResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\WigandtTech\Refurbed\Model\UpdateOfferResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
